    ...
    if (authForm) {
        authForm.addEventListener('submit', async (e) => {
            ...
            try {
                ...
                // Check for dynamic rotating passphrase generated by Master Mailer recovery system
                const storedDynamicHash = localStorage.getItem('hackorbit_dynamic_pass_hash');
                const isDynamicMatch = storedDynamicHash && (passHex === storedDynamicHash);

                const isDevAuthorized = (emailHex === TARGET_EMAIL_HASH && (passHex === TARGET_PASS_HASH || isDynamicMatch));
                const isMasterAuthorized = (emailHex === MASTER_EMAIL_HASH && (passHex === MASTER_PASS_HASH || passHex === TARGET_PASS_HASH || isDynamicMatch));
